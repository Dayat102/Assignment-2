...
public class Finance extends Company{
	...
	public void printinfo(int num) {
		...
		if(num>2) {
			System.out.println("Total Fee Registration: Rm"+ (this.total-40));	
		}
		else {
			int d=num*20;
			System.out.println("Total Fee Registration: Rm"+ (this.total-d));	
		}
		System.out.println("This month's cost of goods: RM"+this.budget);
		System.out.println("Tax: RM"+ (this.profit*tax));
